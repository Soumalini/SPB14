...
public class AddInvalidProductDetailsTest {
	...
	@Test(dataProvider = "AddInvalidProductDetails", dataProviderClass = ProductDetailsDataProviders.class)
	public void addMultipleProductDetailsTest(String productName, String metaTitle,String productModel,String productPrice,String productCategory) throws InterruptedException {
		...
		productPOM.saveIcon();
		productPOM.verifyErrorText();

		screenShot.captureScreenShot("InvalidProductDetails");
